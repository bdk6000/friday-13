...
* () seconds after being dropped, vehicle parts will show up as an icon on all available Counselor maps. The icons will not appear on items that have not yet been picked up or on items currently being held. Jason is unable to see these icons on his map. If a Counselor escapes with the part or drops it in the water, the item will respawn somewhere on the map.
