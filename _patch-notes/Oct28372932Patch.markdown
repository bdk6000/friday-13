...
<h3 style="text-align: center;"><span style="font-size:40px;"><strong>Tommy Jarvis 2.0 Update (AND JARVIS TAPES)</strong></span></h3>
<p>&nbsp;</p>
...
* Tommy Jarvis Tapes have been added and include -
* Tommy Jarvis no longer says “I need to get out of here” when he spawns 
* The text that displays when Tommy Jarvis spawns has been changed from “Escape!” to “Save the other counselors!” 
* Tommy Jarvis is no longer startled by dead bodies
* Tommy Jarvis spawns with a Medical Spray and Pocket Knife

<p>&nbsp;</p>

To incentivise these new character goals and discourage players from escaping on their own as Tommy Jarvis, we have added XP bonuses for TJ players that sacrifice themselves for their teammates and assist escaping Counselors.

* Jarvis is granted XP for Counselors who escape while he is nearby 
Multiple bonuses? What is the range on this? Should we even disclose that?
* Jarvis is granted XP for sacrificing himself while there are any living Counselors nearby
    * This is a one time bonus per match. The bonus will not be granted multiple times for multiple Counselors in the vicinity. Any deaths caused by Jason will grant XP - this includes death by traps. Deaths due to suicide or team kill are excluded from the bonus XP.
* Added an additional post round reward screen for players chosen as Tommy Jarvis. This will be shown after the normal Counselor reward screen and will display the bonus XP granted from playing as Tommy.

<p><a title="Jarvis Tape" href="/uploads/JarvisTape1.jpg"><img style="display: block; margin-left: auto; margin-right: auto;" src="/uploads/JarvisTape1.jpg" alt="Jarvis Tape" width="760" /></a></p>
...
---
<p>&nbsp;</p>
* Jason will now properly receive kill credit when a counselor disconnects during a kill animation 

  *`"This was a QUOTE QUOTE QUOTE QUOTE QUOTE QUOTE QUOTE"`*
<p>&nbsp;</p>
<p>&nbsp;</p>

<h4 align="center">Vehicle Parts show up on the map when dropped</h4>
---
<p>&nbsp;</p>
* () seconds after being dropped, vehicle parts will show up as an icon on all available Counselor maps. These icons will not appear on items that have not yet been picked up or on items currently being held. Jason is unable to see these icons on his map. If a Counselor escapes with a vehicle part or drops it in the water, the item will respawn somewhere else on the map.

  *`"It was frustrating in the later stages of a match for Counselors when vehicle parts were taken from their spawns and lost in a large map. Being able to locate your win condition is an important part of the game and this QoL change should help alleviate some issues"`* 
<p>&nbsp;</p>
<p>&nbsp;</p>

<h4 align="center">Jason's Grab adjusted</h4>
---
<p>&nbsp;</p>
* Jason's Grab **radius** and **maximum range** has been reduced
...
* Pressing [UP] on the D-Pad brings up the Scoreboard as it did originally
  ...
  *`"The button to activate the sweater remains unchanged."`*
...
<h4 align="center">Jason Part/2/6/9 Stats adjusted</h4>
---
<p>&nbsp;</p>
...
* **Jason**
  ...
  * Added a minimum required distance between Jason traps to prevent being able to "chain stun" Counselors
